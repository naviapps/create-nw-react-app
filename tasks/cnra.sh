...
# ******************************************************************************
# Pack nw-react-scripts so we can verify they work.
# ******************************************************************************

# Install all our packages
"$root_path"/node_modules/.bin/lerna bootstrap

cd packages/nw-react-scripts
...
# If Yarn is installed, clean its cache because it may have cached nw-react-scripts
yarn cache clean || true

# Go back to the root directory and run the command from here
cd "$root_path"
node packages/create-nw-react-app/index.js --scripts-version="$scripts_path" "$@"
